#!/usr/bin/env python3
"""Independent evaluator for the Norm-Matched follow-up with explicit validity checks.
...
def main() -> None:
    ...
    parser.add_argument("--root", type=Path, default=Path("norm_matched_outputs"))
